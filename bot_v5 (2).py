...
async def handle_briefing(update, date_str: str = None):
    ...
    # 캐스퍼 명령서 #006 §3 반영 — work_start_time/work_end_time/work_hours
    # (계산 아님, raw_calls 배차시각의 최초/최종값을 조회해서 daily_summary에 저장)
    ...
    try:
        ...
        logger.error(f"daily_summary 운행시간 저장 오류: {e}")
