            ...
            try:
                ...
                if is_daily:
                    _DAEGU_DONG_MAP = (
                        ...
                        "달서구:두류3동,본리동,감삼동,죽전동,장기동,이곡1동,신당동,월성2동,상인1동,상인2동,상인3동,도원동,송현1동,송현2동,본동,용산1동,용산2동,이곡2동,성당동,두류1,2동,월성1동,진천동,유천동;"
                        "달성군:화원읍,논공읍,다사읍,가창면,하빈면,옥포읍,현풍읍,유가읍,구지면;"
                        "동구:신암1동,신암2동,신암3동,신암4동,신암5동,신천1·2동,신천3동,신천4동,효목1동,효목2동,도평동,불로·봉무동,지저동,동촌동,방촌동,해안동,안심1동,안심2동,안심3·4동,혁신동,공산동;"
                        "북구:칠성동,침산1동,침산2동,침산3동,고성동,대현동,산격1동,산격2동,산격3동,산격4동,복현1동,복현2동,검단동,무태조야동,관문동,읍내동,관음동,태전1동,태전2동,구암동,국우동,동천동,노원동;"
                    ...
                    prompt = (
                        ...
                        '흐리거나 잘려서 확신이 안 서면 "미확인"으로 반환해라.\n'
                        f'⚠️ 대구 구-동 공식 매핑표(구:동1,동2,...;구2:...): {_DAEGU_DONG_MAP}\n'
                        '이 표에 있는 동 이름을 읽었으면 반드시 표에 적힌 구로 맞춰서 반환해라(예: "동인동"을 읽었는데 화면상 다른 줄과 '
                        '헷갈려 "북구"로 보이더라도, 표에 동인동=중구이므로 "중구 동인동"으로 반환). 여러 운행 건을 연속으로 읽을 때 '
                        '위/아래 줄의 구 표기가 서로 섞이지 않도록 각 건을 한 줄씩 따로 확인해라. 표에 없는 동은 화면에 보이는 대로 적어라'
                        '(대구 밖 지명일 수 있음). JSON만 반환.'
                    )
                else:
                    prompt = (
